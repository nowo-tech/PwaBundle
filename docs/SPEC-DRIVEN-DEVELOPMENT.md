...
1. **Product behavior** — what **PwaBundle** guarantees to Symfony applications (manifest, service worker, Twig helpers, client script). This is spelled out below and in [`USAGE.md`](USAGE.md) / [`CONFIGURATION.md`](CONFIGURATION.md); **PHPUnit**, **Vitest**, and **PHPStan** enforce it in CI.
